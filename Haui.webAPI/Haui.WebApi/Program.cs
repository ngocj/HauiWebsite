using Haui.Application.Services.Implementation;
using Haui.Application.Services.Interfaces;
using Haui.Applications.Mappings;
...
builder.Services.AddDbContext<HauiContext>(option => option.UseSqlServer(builder.Configuration.GetConnectionString("HauiConnection")));
